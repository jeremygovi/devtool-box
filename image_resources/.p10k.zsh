# Generated by Powerlevel10k configuration wizard on 2024-12-26 at 10:03 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: compatible, lean_8colors, ascii, 24h time, 1 line, compact, concise,
